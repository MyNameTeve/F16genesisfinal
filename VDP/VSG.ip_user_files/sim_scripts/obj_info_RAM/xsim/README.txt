...
#
# Generated by export_simulation on Fri Dec 09 10:44:02 -0500 2016
#
################################################################################
...
switch to the './obj_info_RAM.sh' script.

./obj_info_RAM.sh -reset_run
...
./obj_info_RAM.sh -noclean_files

For more information on the script, please type './obj_info_RAM.sh -help'.
