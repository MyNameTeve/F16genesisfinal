...
HD_PWD='C:/Workspace/F16genesisfinal/VDP/VSG.runs/col_info_RAM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log col_info_RAM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source col_info_RAM.tcl
