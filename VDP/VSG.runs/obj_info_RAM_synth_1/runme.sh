...
HD_PWD='C:/Workspace/F16genesisfinal/VDP/VSG.runs/obj_info_RAM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log obj_info_RAM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source obj_info_RAM.tcl
