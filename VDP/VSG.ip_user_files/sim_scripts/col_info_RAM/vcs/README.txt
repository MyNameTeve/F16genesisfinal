...
#
# Generated by export_simulation on Fri Dec 09 10:46:40 -0500 2016
#
################################################################################
...
switch to the './col_info_RAM.sh' script.

./col_info_RAM.sh -reset_run
...
./col_info_RAM.sh -noclean_files

For more information on the script, please type './col_info_RAM.sh -help'.
